            ...
            <div class="col-12">
                <div class="card mb-0">
                    <div class="card-header pb-0">
                        ...
                        <?php endif; ?>
                        <a href="<?= base_url('table/table2d/export') ?>"
                                ...
                                <tbody>
                                    ...
                                    foreach ($table2d as $row): ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('table/table2d/' . $row['no'] . '/edit') ?>"
                                                    class="btn bg-gradient-info btn-sm">Edit</a>
                                                <a href="#"
                                                    data-href="<?= base_url('table/table2d/' . $row['no'] . '/delete') ?>"
                                                    ...
                                                    <form action="<?= base_url('table/table2d/new') ?>" method="post">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" class="form-control"
                                                                name="sumber_rekognisi" required>
                                                        </div>

                                                        <label>Jenis Pengakuan Lulusan</label>
                                                        <div class="input-group mb-3">
                                                            <input type="text" class="form-control"
                                                                name="jenis_pengakuan_lulusan" required>
                                                        </div>

                                                        <label>Tahun Akademik</label>
                                                        <div class="input-group mb-3">
                                                            <input type="text" class="form-control"
                                                                name="tahun_akademik" placeholder="2023/2024" required>
                                                        </div>
                                                        ...
                                                        <button type="submit"
                                                            class="btn bg-gradient-primary btn-lg btn-rounded w-100 mt-4 mb-0">Simpan
                                                            Data</button>
