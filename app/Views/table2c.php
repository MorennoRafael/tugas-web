        ...
        <div class="card mb-0">
          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
              <table class="table table-hover align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder ">Tahun Akademi
                    </th>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder ">Jenis
                      Pembelajaran</th>
                ...
                <tbody>
                  ...
                  foreach ($table2c as $row): ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="<?= base_url('table/table2c/' . $row['id'] . '/edit') ?>"
                          class="btn bg-gradient-info btn-sm">
                          Edit
                        </a>
                        <a href="#" data-href="<?= base_url('table/table2c/' . $row['id'] . '/delete') ?>"
                          onclick="confirmToDelete(this)" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal"
                          data-bs-target="#confirm-dialog">Hapus</a>
                      </td>
                    </tr>
                    <?php $no++; endforeach ?>
                </tbody>
                ...
                <tfoot>
                  <tr class="bg-gray-100">
                    <th colspan="3" class="text-center text-uppercase text-secondary text-xs font-weight-bolder">Jumlah
                    </th>
                  ...
                  <tr class="bg-gray-100">
                    <th colspan="3" class="text-center text-uppercase text-secondary text-xs font-weight-bolder">
                      Persentase</th>
              ...
              <div class="modal fade" id="confirm-dialog" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                      ...
                      <div class="card card-plain">
                        ...
                        <div class="card-body pb-3">
                          <form action="<?= base_url('table/table2c/new') ?>" method="post" role="form text-left">
                            ...
                            <div class="input-group mb-3">
                              <input type="text" class="form-control" name="JenisPembelajaran"
                                placeholder="Jenis Pembelajaran" required>
                            </div>
                            ...
                            <button type="submit"
                              class="btn bg-gradient-primary btn-lg btn-rounded w-100 mt-4 mb-0">Simpan Data</button>
                          </form>
                        </div>
                      </div>
                    </div>
