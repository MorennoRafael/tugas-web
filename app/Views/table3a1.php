                            ...
                            <table class="table table-hover align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Nama Prasarana</th>
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Daya Tampung</th>
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Luas Ruang</th>
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Kepemilikan</th>
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Lisensi</th>
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder">Perangkat</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($table3a1 as $row): ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('table/table3a1/' . $row['no'] . '/edit') ?>" class="btn bg-gradient-info btn-sm">Edit</a>
                                                <a href="#" data-href="<?= base_url('table/table3a1/' . $row['no'] . '/delete') ?>" onclick="confirmToDelete(this)" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#confirm-dialog">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php $no++;
                                    endforeach ?>
                                        ...
                                        <div class="modal-body p-0">
                                            <div class="card card-plain">
                                                <div class="card-header pb-0 text-left">
                                                    <h3 class="font-weight-bolder text-primary text-gradient">Tambah Data 3A1</h3>
                                                ...
                                                <div class="card-body pb-3">
                                                    <form action="<?= base_url('table/table3a1/new') ?>" method="post">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="number" class="form-control" name="daya_tampung" required>
                                                        </div>

                                                        <label>Luas Ruang</label>
                                                        <div class="input-group mb-3">
                                                            <input type="text" class="form-control" name="luas_ruang" required>
                                                        </div>
                                                        ...
                                                        <label>Lisensi</label>
                                                        <div class="input-group mb-3">
                                                            <input type="text" class="form-control" name="lisensi" required>
                                                        </div>

                                                        <label>Perangkat</label>
                                                        <div class="input-group mb-3">
                                                            <input type="text" class="form-control" name="perangkat" required>
                                                        </div>
